  ...
  try {
    ...
    comunicadosFiltrados.forEach((e) => {
      ...
      const linkDocumento = e.documento
        ? `<a href="https://integrada-api.onrender.com/documentos-disponiveis/comunicados/${e.documento}" target="_blank" class="btn-ver"><i class="fas fa-file-pdf"></i> Ver Documento</a>`
